...
class DatabaseHelper {
  ...
  Future<int> insertSensorData(SensorData data) async {
    ...
    print(
        'InsertSensorData: Inserido com sucesso | ID: $id, Heart Rate: ${data.heartRate}, Calories: ${data.calories}, Steps: ${data.steps}, Distance: ${data.distance}, Speed: ${data.speed}, Water: ${data.water}, Received Date: $timestamp');
    return id;
  }
  ...
  Future<List<SensorData>> fetchTodaysHeartRateData() async {
    ...
    final List<Map<String, dynamic>> maps = await db.query(
      ...
      orderBy:
          "receivedDate ASC", // Order by date ascending to get chronological order
    );
  ...
  Future<List<HeartRateExtremes>> fetchMonthlyHeartRateData() async {
    ...
    final startDate = endDate.subtract(
        const Duration(days: 29)); // Changed to fetch the last 30 days
