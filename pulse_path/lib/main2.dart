...
import 'package:pulse_path/util.dart';
...
class _HealthAppState extends State<HealthApp> {
  ...
  final permissions = types.map((e) => HealthDataAccess.READ).toList();
    ...
    // Defina a instância do GoogleSignIn
  ...
  // Método para autenticar com o Google Sign-In
  Future<void> signInWithGoogle() async {
    try {
      final GoogleSignInAccount? account = await _googleSignIn.signIn();
      if (account != null) {
        print('Login do Google bem-sucedido: $account');
        // Após o sucesso do login, prossegue com a autorização do Health
        authorize();
      }
    } catch (error) {
      print('Erro ao fazer login no Google: $error');
    }
  }
